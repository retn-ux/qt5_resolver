...
#ifdef _DEBUG
#pragma comment(lib, "pluginsdk/godzilla/Godzilla_debug_x64.lib")
#endif

#ifndef _DEBUG
#pragma comment(lib, "pluginsdk/godzilla/Godzilla_x64.lib")
#else
...
#ifdef _DEBUG
#pragma comment(lib, "pluginsdk/godzilla/Godzilla_debug_x86.lib")
#endif

#ifndef _DEBUG
#pragma comment(lib, "pluginsdk/godzilla/Godzilla_x86.lib")
#endif //_WIN64

#define Cmd(x) DbgCmdExecDirect(x)
#define Eval(x) DbgValFromString(x)
#define PLUG_EXPORT extern "C" __declspec(dllexport)
#define LogPrintf(message)\
